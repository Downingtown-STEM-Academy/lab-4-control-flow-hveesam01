...
let isAverage: Bool = currentAverage > targetLowerBound && targetUpperBound < currentAverage
let isBelowAverage: Bool = currentAverage < targetLowerBound
let isAboveAverage: Bool = currentAverage > targetUpperBound
